...
namespace Sieve
{
    ...
    Consigna:
        ...
        Quiere probar el rendimiento de diferentes combinaciones de piezas y decide crear su propio programa de evaluación comparativa para comparar sus ordenadores. Elige el famoso algoritmo "Criba de Eratóstenes"
    , un algoritmo antiguo, pero que debería llevar sus ordenadores al límite.
        ...
        Un número primo es un número mayor que 1 que solo es divisible por 1 y por sí mismo. Por ejemplo, 2, 3, 5, 7, 11 y 13 son números primos. Por el contrario, 6 no es un número primo,
    ya que no solo es divisible por 1 y por sí mismo, sino también por 2 y 3.
    ...
    */
    ...
    public static class Sieve
    {
        ...
        public static int[] Primes(int limit)
        {
            if (limit < 0)
            {
                throw new ArgumentOutOfRangeException("limit fuera de rango");
            }
            else
            {
